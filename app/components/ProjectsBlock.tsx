...
const projects = [
	{
		...
		year: '2024',
		description:
			'Предоставление медицинской, образовательной и воспитательной помощи детям раннего возраста без попечения родителей с психоневрологическими диагнозами, поражениями ЦНС или врожденными аномалиями развития',
		contracts: 5,
		years: 1,
	},
	{
		...
		year: '2024 / Н.В.',
		description:
			'Образовательная деятельность по различным направлениям (занятия в кружках и студиях, мастер-классы, мероприятия для детей, научно-исследовательская деятельность)',
		contracts: 5,
		years: 2,
	},
	{
	...
	},
	{
		...
		year: '2024 / 2025',
		description:
			'Обеспечение транспортного обслуживания государственных органов Ленинградской области',
		contracts: 5,
		years: 1,
	},
	{
		...
		year: '2025',
		description:
			'Организация и проведение массовых культурных и спортивных мероприятий, направленных на вовлечение населения в активный досуг, а также строительство культурно-массовых объектов',
		contracts: 5,
		years: 1,
	},
	{
		...
		year: '2025',
		description:
			'Преподавание дисциплин (рисунок, живопись, композиция, скульптура, история искусств и декоративно-прикладное искусство) для развития творческого мышления у детей',
		contracts: 5,
		years: 1,
	},
	{
	...
	},
	{
		...
		year: '2025',
		description:
			'Развитие творческих способностей детей в различных областях искусства: музыка, изобразительное искусство, хореография и другие',
		contracts: 5,
		years: 1,
	},
	{
		...
		year: '2025',
		description:
			'Диагностика, лечение и профилактика психических расстройств, а также реабилитация пациентов и оказанием им психосоциальной помощи',
		contracts: 5,
		years: 1,
	},
]
		...
		<div className={styles.projectsBlock}>
			<div className={styles.container}>
				<div className={styles.header}>
					...
					<h2 className={styles.hideTitle}>как мы решаем задачи</h2>
					<h3 className={styles.hideSubtitle}>и создаём безопасную среду</h3>
					<p className={styles.description}>
						РЕАЛЬНЫЕ ПРИМЕРЫ НАДЕЖНОЙ ЗАЩИТЫ И СЕРВИСА
						<br />
						ДЛЯ КОМПАНИЙ РАЗЛИЧНЫХ МАСШТАБОВ
					</p>
					<p className={styles.hideDescription}>для бизнеса и жизни</p>
				</div>
							...
							<div key={project.id}>
								<div
									className={`${styles.projectRow} ${
										isExpanded ? styles.projectRowExpanded : ''
									}`}
									onClick={() => {
										if (isExpanded) {
											setExpandedProjects(
												expandedProjects.filter(id => id !== project.id)
											)
										} else {
								...
								>
									...
									>
										...
										>
											...
											/>
											<path
												d='M13 7L13 5.5L19 5.5V7L13 7Z'
												fill='white'
												fill-opacity='0.5'
											/>
											<path
												d='M13 24.5V23H19V24.5H13Z'
												fill='white'
												fill-opacity='0.5'
											/>
											<path
											...
											/>
											<path
												d='M43 7L43 5.5L49 5.5V7H43Z'
												fill='white'
												fill-opacity='0.5'
											/>
											<path
												d='M43 24.5L43 23H49V24.5H43Z'
												fill='white'
												fill-opacity='0.5'
											/>
											<path
												d='M32 20.8916L36.2832 16.2129H39L32.5098 23.2129H29.4902L23 16.2129H25.626L30 21.0225V7H32V20.8916Z'
												fill='white'
											/>
										</svg>
									</button>
				...
				{hasMore && !showAll && (
					<div className={styles.footer}>
						<ActionButton onClick={() => setShowAll(true)}>
							Показать ещё
						</ActionButton>
					</div>
				)}
